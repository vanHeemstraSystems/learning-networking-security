...
This repository includes a **[complete Docker-based security testing lab](./500/README.md)** that creates an isolated, safe environment for practicing security techniques.

### Quick Start with Docker Lab
...
# Access the Kali attacker container
./lab-manager.sh kali
...
- **Attacker Machine**: Kali Linux with pre-installed tools
- **Web Targets**: DVWA, WebGoat, bWAPP, Juice Shop
- **Network Services**: SSH, FTP, Telnet, MySQL, PostgreSQL, Redis, MongoDB
- **Monitoring**: Wireshark for traffic analysis
- **Isolated Network**: Completely separated from your actual network

See `docker-lab/LAB-SETUP.md` for complete documentation.
